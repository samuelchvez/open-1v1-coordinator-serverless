export default {
  ...
  iamRoleStatements: [
    ...
    },
    {
      ...
      Resource: 'arn:aws:dynamodb:${self:provider.region}:*:table/${self:provider.environment.MATCHES_TABLE_NAME}/index/${self:provider.environment.MATCHES_PLAYER1_INDEX_NAME}',
    },
    {
      Effect: 'Allow',
      Action: [
      ...
      Resource: 'arn:aws:dynamodb:${self:provider.region}:*:table/${self:provider.environment.MATCHES_TABLE_NAME}/index/${self:provider.environment.MATCHES_PLAYER2_INDEX_NAME}',
    },
    {
      Effect: 'Allow',
      Action: [
